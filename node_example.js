...
postForm(hostname + '/cas/v1/tickets', {username:username, password:password})
	...
	.then((serviceTicket) => {
		const url = hostname + '/ulkoiset-rajapinnat/api/hakemus-for-haku/1.2.246.562.29.00000000000000038404?ticket=' + serviceTicket + '&koulutuksen_alkamisvuosi=2024&koulutuksen_alkamiskausi=kausi_s%231'
